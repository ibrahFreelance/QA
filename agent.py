...
from test import synonyms_antonyms_tool, synonyms_antonyms_generation_tool
...
async def chatbot(question: str = Form(...)):
    try:
        ...
        agent = ReActAgent.from_tools([error, complate, synonyms_antonyms_tool, synonyms_antonyms_generation_tool],
